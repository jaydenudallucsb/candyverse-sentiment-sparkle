  ...
  return (
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-6 space-y-16">
        ...
        {/* The Unwrap.ai Solution - Large Bridge Section */}
        <motion.div
        ...
        >
          ...
          <div className="glass p-12 md:p-16 rounded-3xl border-2 border-primary/20 space-y-8">
            <div className="text-center space-y-6">
              ...
              >
                <div className="text-5xl md:text-6xl font-light bg-gradient-to-r from-primary via-primary/80 to-primary bg-clip-text text-transparent">
                  Unwrap.ai
                </div>
              </motion.div>
              <p className="text-2xl md:text-3xl text-foreground/90 font-light leading-relaxed max-w-4xl mx-auto">
                We transform the chaos of online conversations into crystallized competitive intelligence
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              ...
              <motion.div
                ...
                className="space-y-4 p-8 rounded-2xl bg-destructive/5 border border-destructive/20"
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-destructive/20 flex items-center justify-center">
                    <TrendingDown className="w-6 h-6 text-destructive" />
                  </div>
                  <h3 className="text-xl font-semibold text-destructive">Traditional Research</h3>
                </div>
                <ul className="space-y-3 text-foreground/70">
                  <li className="flex items-start gap-2">
                    <span className="text-destructive mt-1">×</span>
                    <span>Surveys take weeks, cost $50K+</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-destructive mt-1">×</span>
                    <span>Response bias and leading questions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-destructive mt-1">×</span>
                    <span>Small sample sizes (200-500 responses)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-destructive mt-1">×</span>
                    <span>Stale data by the time you get results</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-destructive mt-1">×</span>
                    <span>No competitive comparison context</span>
                  </li>
                </ul>
              </motion.div>
              ...
              <motion.div
                ...
                className="space-y-4 p-8 rounded-2xl bg-primary/5 border border-primary/20"
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center">
                    <TrendingUp className="w-6 h-6 text-primary" />
                  </div>
                  <h3 className="text-xl font-semibold text-primary">Unwrap.ai Method</h3>
                </div>
                <ul className="space-y-3 text-foreground/70">
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">✓</span>
                    <span>4,662 authentic Reddit comments scraped in hours</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">✓</span>
                    <span>Unfiltered, unsolicited user feedback</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">✓</span>
                    <span>Real-time sentiment analysis across platforms</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">✓</span>
                    <span>Automated weekly insights and trend detection</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">✓</span>
                    <span>Head-to-head competitive feature mapping</span>
                  </li>
                </ul>
              </motion.div>
            </div>
          ...
          >
            <div className="text-center space-y-4">
              ...
              <p className="text-xl text-foreground/70 max-w-3xl mx-auto">
                This isn't a dashboard. It's a living map of competitive sentiment, visualized as a universe.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div
                ...
                className="glass p-6 rounded-2xl border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(var(--primary),0.2)] space-y-4"
              >
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-slack/40 to-slack/10 flex items-center justify-center">
                  <Globe className="w-7 h-7 text-slack" />
                </div>
                <h3 className="text-xl font-semibold text-foreground">The Central Planet</h3>
                <p className="text-foreground/70">
                  Slack sits at the center with 56.5% positive sentiment. Its size reflects market position, 
                  its glow represents sentiment strength, and orbiting clusters show feature-level feedback.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="glass p-6 rounded-2xl border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(var(--primary),0.2)] space-y-4"
              >
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-accent/40 to-accent/10 flex items-center justify-center">
                  <Layers className="w-7 h-7 text-accent" />
                </div>
                <h3 className="text-xl font-semibold text-foreground">Competitive Moons</h3>
                <p className="text-foreground/70">
                  Discord and Teams orbit Slack as moons. Distance represents sentiment similarity—closer moons 
                  share similar user experiences. Click any moon to dive into platform-specific insights.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-foreground">Live Intelligence</h3>
                <p className="text-foreground/70">
                  Every element is data-driven: planet sizes, orbital distances, glow intensity, cluster positions. 
                  33 features tracked, sentiment analyzed, temporal trends detected—all in real-time.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="glass p-10 rounded-3xl border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-transparent"
          >
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div className="space-y-2">
                <div className="text-4xl md:text-5xl font-light text-primary">4,662</div>
                <div className="text-sm text-foreground/60 uppercase tracking-wider">Reddit Comments</div>
              </div>
              <div className="space-y-2">
                <div className="text-4xl md:text-5xl font-light text-primary">33</div>
                <div className="text-sm text-foreground/60 uppercase tracking-wider">Features Tracked</div>
              </div>
              <div className="space-y-2">
                <div className="text-4xl md:text-5xl font-light text-primary">3</div>
                <div className="text-sm text-foreground/60 uppercase tracking-wider">Platforms Compared</div>
              </div>
              <div className="space-y-2">
                <div className="text-4xl md:text-5xl font-light text-primary">84%</div>
                <div className="text-sm text-foreground/60 uppercase tracking-wider">Feature Overlap</div>
              </div>
            </div>
          </motion.div>
        </motion.div>
